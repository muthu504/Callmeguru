 ...
 */
@WebServlet(name = "StoreProviderMessages", urlPatterns = {"/StoreProviderMessages"})
public class StoreProviderMessages extends HttpServlet {
   ...
   @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "insert into providermessages(email,phone,subject,description) values(?,?,?,?)";
            ...
            int c = p1.executeUpdate();
             ...
             out.print("<h1 align=center><i>Successfully stored.  <a href=/CallMeGuru/ProviderMessages>View Messages</a></i></h1>");
